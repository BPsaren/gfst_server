...
const ValidateLoanAccountSchema = z.object({
  consumer_name: z
  ...
  address: z
    ...
    starting_loan: z
    .string({ required_error: "starting_loan is required" })
    .trim()
    .min(3, { message: "starting_loan  must be at least 3 characters" })
    .max(255, { message: "starting_loan  must be at most  255 characters" }),

});


module.exports = {  ValidateLoanAccountSchema };
